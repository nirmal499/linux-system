/* This program will send signals to the daemon [my-daemon-v2.c], just like
...
int main(int argc, char *argv[])
{
    ...
    /* Now, we need to assemble the complete path to the process's cmdline file in /proc.
        Then, we must open that file and read the complete command-line path from it: */
    /* build the /proc path */
